...
public class Service {
    ...
    private final JavaType playerList =
            CollectionType.construct(List.class,
                    SimpleType.construct(Player.class));

    private final JavaType teamList =
            CollectionType.construct(List.class,
                    SimpleType.construct(Team.class));
...
//            return mapper.readerFor(javaType).readTree(is);
        } catch (IOException e) {
