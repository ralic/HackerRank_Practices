...
const char sign_Mtbl_WaySensor[] = "WaySensor"; //to mark method tables of all implementations


/**gets a actual way*/
/*J2C: dynamic call variant of the override-able method: */
int32 getWay_WaySensor(ObjectJc* ithis, ThCxt* _thCxt)
{ Mtbl_WaySensor const* mtbl = (Mtbl_WaySensor const*)getMtbl_ObjectJc(ithis, sign_Mtbl_WaySensor);
 ...
 static struct superClasses_WaySensor_s_t
 { ObjectArrayJc head;
   ClassOffset_idxMtblJc data[1];
 }superclasses_WaySensor_s =
 { CONST_ObjectArrayJc(ClassOffset_idxMtblJc, 1, OBJTYPE_ClassOffset_idxMtblJc, null, null)
 , { {&reflection_ObjectJc, 0 /*J2C: no Mtbl*/ }
   }
 };

const ClassJc reflection_WaySensor_s = 
...
, null //method
, (ClassOffset_idxMtblJcARRAY*)&superclasses_WaySensor_s //superclass
, null //interfaces
, 0    //modifiers
};
