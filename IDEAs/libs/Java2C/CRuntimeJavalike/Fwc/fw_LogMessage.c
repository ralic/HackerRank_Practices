...
void flush_LogMessageFW(LogMessageFW_i* ythis, ThCxt* _thCxt)
{
  ...
  if( (int)mtbl->head.sizeTable >= (MemUnit*)(mtbl->flush) - (MemUnit*)(mtbl))
...
void close_LogMessageFW(LogMessageFW_i* ythis, ThCxt* _thCxt)
{
  ...
  if(mtbl == null) THROW_s0(IllegalArgumentException, "Method-table not found",0);
  if(mtbl->head.sign != sign_Mtbl_LogMessageFW) THROW_s0(IllegalArgumentException, "The found Method-table is not correct", (int)mtbl);
  if( (int)mtbl->head.sizeTable >= (MemUnit*)(mtbl->close) - (MemUnit*)(mtbl))
...
bool isOnline_LogMessageFW(LogMessageFW_i* ythis, ThCxt* _thCxt)
{
  ...
  if(mtbl == null) THROW_s0(IllegalArgumentException, "Method-table not found",0);
  if(mtbl->head.sign != sign_Mtbl_LogMessageFW) THROW_s0(IllegalArgumentException, "The found Method-table is not correct", (int)mtbl);
  if( (int)mtbl->head.sizeTable >= (MemUnit*)(mtbl->isOnline) - (MemUnit*)(mtbl))
