 ...
 */
METHOD_C int getBitfield_FieldJc(const FieldJc* ythis, MemSegmJc instance, char const* sVaargs, ...);
...
{ //ObjectJc super;
  //StringJcRef  name;
  char name[kLengthNAME_CLASS_ReflectionJc];
...
{ ObjectJc object;
  ...
  char name[kLengthNAME_METHOD_ReflectionJc];
...
, mObjectifcBaseJcpp_Modifier_reflectJc  =  0x08000000
     ...
     * 
     */
#define mContainerinstance_Modifier_reflectJc 0x30000000
...
#define isReference_ModifierJc(VALUE) ( (VALUE & mAddressing_Modifier_reflectJc) != 0)
...
#define mReference_Modifier_reflectJc kReference_Modifier_reflectJc  
