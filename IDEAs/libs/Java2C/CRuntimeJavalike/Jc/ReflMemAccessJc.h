...
#define INIT_null_MemSegmJc(THIS) set_OS_PtrValue(THIS, 0, null)

#define INIT_MemSegmJc(THIS) set_OS_PtrValue(THIS, 0, null)

#define INIT_AddrSegm_MemSegmJc(THIS, ADDR, SEGM) set_OS_PtrValue(THIS, SEGM, ADDR)

#define setNull_MemSegmJc(THIS) set_OS_PtrValue(*(THIS), 0, null)

#define setAddrSegm_MemSegmJc(THIS, ADDR, SEGM) set_OS_PtrValue(*(THIS), SEGM, ADDR)
...
#define CONST_MemSegmJc(ADDR, SEGM) CONST_OS_PtrValue(SEGM, ADDR) 
 ...
 */
int getBitfield_MemAccessJc(MemSegmJc addr, int posBit, int nrofBit);
