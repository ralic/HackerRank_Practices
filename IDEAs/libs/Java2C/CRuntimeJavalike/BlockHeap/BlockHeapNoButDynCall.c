...
*/
bool clearRef_Object(ObjectRefValuesJc* refbase)
{ return true;
}
...
*/
bool setRef_ObjectJc(ObjectRefValuesJc* refbase, ObjectJc* src, struct ClassJc_t* reflectionRef) //uint16 idxVtbl)
{ return true;
}
