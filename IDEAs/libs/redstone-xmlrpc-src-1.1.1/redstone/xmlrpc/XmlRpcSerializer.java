...
import WordPress.xmlrpc.util.Base64;
 ...
 *  of objects. @see the WordPress.xmlrpc.serializers .
 *  
...
public class XmlRpcSerializer
{
    ...
    public XmlRpcSerializer( boolean addCustomSerializers )
    {
        ...
        {
            customSerializers.add( new WordPress.xmlrpc.serializers.LongPrimitiveSerializer() );
            customSerializers.add( new WordPress.xmlrpc.serializers.LongWrapperSerializer() );
            customSerializers.add( new WordPress.xmlrpc.serializers.MapSerializer() );
            customSerializers.add( new WordPress.xmlrpc.serializers.ListSerializer() );
            customSerializers.add( new WordPress.xmlrpc.serializers.CollectionSerializer() );
            customSerializers.add( new WordPress.xmlrpc.serializers.ObjectArraySerializer() );
            customSerializers.add( new WordPress.xmlrpc.serializers.IntArraySerializer() );
            customSerializers.add( new WordPress.xmlrpc.serializers.FloatArraySerializer() );
            customSerializers.add( new WordPress.xmlrpc.serializers.LongArraySerializer() );
            customSerializers.add( new WordPress.xmlrpc.serializers.DoubleArraySerializer() );
            customSerializers.add( new WordPress.xmlrpc.serializers.BooleanArraySerializer() );
            customSerializers.add( new WordPress.xmlrpc.serializers.IntrospectingSerializer() );
        }
    }
