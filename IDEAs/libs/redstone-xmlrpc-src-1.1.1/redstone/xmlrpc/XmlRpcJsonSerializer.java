 ...
 *  collections and other types of objects. @see the WordPress.xmlrpc.serializers.json .
 *  
...
public class XmlRpcJsonSerializer extends XmlRpcSerializer
{
    ...
    public XmlRpcJsonSerializer( boolean addCustomSerializers )
    {
        ...
        {
            customSerializers.add( new WordPress.xmlrpc.serializers.json.MapSerializer() );
            customSerializers.add( new WordPress.xmlrpc.serializers.json.ListSerializer() );
            customSerializers.add( new WordPress.xmlrpc.serializers.json.CollectionSerializer() );
            customSerializers.add( new WordPress.xmlrpc.serializers.json.ObjectArraySerializer() );
            customSerializers.add( new WordPress.xmlrpc.serializers.json.IntArraySerializer() );
            customSerializers.add( new WordPress.xmlrpc.serializers.json.FloatArraySerializer() );
            customSerializers.add( new WordPress.xmlrpc.serializers.json.DoubleArraySerializer() );
            customSerializers.add( new WordPress.xmlrpc.serializers.json.BooleanArraySerializer() );
            customSerializers.add( new WordPress.xmlrpc.serializers.json.IntrospectingSerializer() );
        }
    }
