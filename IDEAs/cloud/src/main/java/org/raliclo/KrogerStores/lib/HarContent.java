    ...
    public HarContent(JsonParser jp, List<HarWarning> warnings)
        ...
        while (jp.nextToken() != JsonToken.END_OBJECT) {
            ...
            if ("size".equals(name))
                ...
                throw new JsonParseException(jp, "Unrecognized field '" + name + "' in content element");
            }
        }
        if (size == null) {
            if (warnings != null)
                ...
                throw new JsonParseException(jp, "Missing size field in content element");
        }
        if (mimeType == null) {
            if (warnings != null)
                ...
                throw new JsonParseException(jp, "Missing mimeType field in content element");
        }
    }
