...
//    val ap: Array[SpectralNorm_Java_Fail.Approximate] = new Array[SpectralNorm_Java_Fail.Approximate](nthread)
...
//        else n
//        ap(i) = new SpectralNorm_Java_Fail.Approximate(u, v, tmp, r1, r2)
//      }
//      {
//        i += 1; i - 1
//      }
