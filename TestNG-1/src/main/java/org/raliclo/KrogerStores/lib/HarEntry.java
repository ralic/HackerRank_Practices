...
public class HarEntry implements Comparable<HarEntry> {
    ...
    public HarEntry(JsonParser jp, List<HarWarning> warnings)
        ...
        if (startedDateTime == null) {
            if (warnings != null)
                ...
                throw new JsonParseException(jp, "Missing startedDateTime field in entries element");
        }
        if (time == null) {
            if (warnings != null)
                ...
                throw new JsonParseException(jp, "Missing time field in entries element");
        }
        if (request == null) {
            if (warnings != null)
                ...
                throw new JsonParseException(jp, "Missing request field in entries element");
        }
        if (response == null) {
            if (warnings != null)
                warnings.add(new HarWarning(
                ...
                throw new JsonParseException(jp, "Missing response field in entries element");
        }
        if (cache == null) {
            if (warnings != null)
                ...
                throw new JsonParseException(jp, "Missing cache field in entries element");
        }
        if (timings == null) {
            if (warnings != null)
                ...
                throw new JsonParseException(jp, "Missing timings field in entries element");
        }
    }
    ...
    public HarEntry(HarDatabaseConfig config, long entryId) throws SQLException {
        ...
        try {
            ...
            } catch (SQLException e) { // Cache is empty
                cache = new HarCache();
            }
