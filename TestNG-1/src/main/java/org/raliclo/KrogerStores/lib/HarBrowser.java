...
public class HarBrowser {
    ...
    public HarBrowser(JsonParser jp, List<HarWarning> warnings)
        ...
        if (jp.nextToken() != JsonToken.START_OBJECT) {
            throw new JsonParseException(jp, "{ missing after \"browser\" element");
        }
        ...
        while (jp.nextToken() != JsonToken.END_OBJECT) {
            ...
            if ("version".equals(name))
                ...
                throw new JsonParseException(jp, "Unrecognized field '" + name + "' in browser element");
            }
        }
        if (name == null) {
            if (warnings != null)
                ...
                throw new JsonParseException(jp, "Missing name field in browser element");
        }
        if (version == null) {
            if (warnings != null)
                ...
                throw new JsonParseException(jp, "Missing version field in browser element");
        }
    }
