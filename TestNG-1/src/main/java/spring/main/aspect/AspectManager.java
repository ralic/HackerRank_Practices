...
import spring.main.bean.UserManager;
...
public class AspectManager {
    ...
    @Before("execution(* spring.main.bean.MailService.send*(*))")
    ...
    @After("execution(* spring.main.bean.RegisterService.register*(*))")
    ...
    @AfterThrowing(value = "execution(void spring.main.bean.UserManager.throw*())", throwing = "e")
    ...
    @AfterReturning(value = "execution(boolean spring.main.bean.UserManager.throw*())", returning = "result")
    ...
    @After("execution(void spring.main.bean.UserManager.throw*())")
    ...
    @Around("execution(boolean spring.main.bean.UserManager.deleteUser(*))")
    ...
    @Pointcut("execution(* spring.main.bean.UserManager.*(*))")
    public void userManagerMethods() {
    }

    @Pointcut("execution(* spring.main.bean.RegisterService.*(*))")
