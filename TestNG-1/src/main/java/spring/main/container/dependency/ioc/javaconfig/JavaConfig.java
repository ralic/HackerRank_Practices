package spring.main.container.dependency.ioc.javaconfig;

import org.springframework.context.annotation.*;
import org.springframework.context.support.PropertySourcesPlaceholderConfigurer;
import spring.main.bean.DataSource;
import spring.main.bean.MailService;
import spring.main.util.ComplexBeanFactoryBeanImplementation;
...
@ComponentScan(basePackages = {"spring.main.bean", "spring.main.aspect"})
...
public class JavaConfig {
	...
	*/
    ...
    public DataSource dataSource() { //default bean id is dataSource
        ...
        dataSource.setPassword("raliclo");
        return dataSource;
    }
