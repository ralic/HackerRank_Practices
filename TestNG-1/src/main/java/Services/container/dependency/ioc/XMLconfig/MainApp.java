package Services.container.dependency.ioc.XMLconfig;
...
import Services.bean.SuperUser;
...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		*/
		...
		Services.bean.UserManager userManager = (Services.bean.UserManager)context.getBean("userManager");
