...
func main() {
	...
	for i := 0; i < numberLines; i++ {
		...
		bool, _ := regexp.MatchString("^[H|h][I|i]\\s[^D|^d]", lines[i])
		if (bool) {
			fmt.Print(lines[i])
		}
	}
...
/*
HI lover game yours tooth tight reckon polish poisonous throw
hI class occasion identity equal dangerous mine recommend
 */
